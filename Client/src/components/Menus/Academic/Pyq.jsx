...
const NotesComponent = () => {
  ...
  return (
    <div className="mt-10 mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Notes Section */}
      <div className="mt-8 p-6 bg-indigo-200 rounded-lg shadow-xl backdrop-blur-md">
          ...
          <div className="flex flex-col gap-4 mb-6">
            {semestersData[selectedSemester].map((subject, idx) => (
              ...
              >
                ...
                >
                  <button className="px-4 py-2 bg-indigo-500 text-white rounded-lg shadow hover:bg-indigo-700 transition">
                    View
                  </button>
                </Link>
              </div>
